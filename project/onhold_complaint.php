...
<div id="wrapper">
	...
	<div id="page">
<h2 align="center">On Hold Complaints</h2>
<br>
<div class="box" align="center">
    ...
    <br>
        <br>
            ...
            <form method="POST" action="update_on_hold.php">
            <?php
...
$val=$row['imagesrc'];
echo '<tr><td>'.$row[complaint_no].'</td><td><img src="'.$row[imagesrc].'"/></td><td> '.$row[location].' </td> <td>'.$row[comment].'</td><td> '.$row[status].'</td><td><select name="'.$i.'"><option name="2">On Hold</option><option name="1">Resolved</option></select></td></tr>';
$i++;
}
echo '</table>';
mysql_close();
